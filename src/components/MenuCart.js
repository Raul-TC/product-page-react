...
const MenuCart = ({ counter, setCounter, setQuantity, setMenuCart }) => {
  ...
  return (
    <div className='absolute z-10 bg-gray-100 w-[95%] h-auto top-0 left-0 right-0 m-auto mt-16 rounded-lg flex flex-col items-center justify-center sm:w-96 sm:right-0 sm:top-0 sm:left-auto sm:-mr-44 sm:m-0'>
